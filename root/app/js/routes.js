...
var {%= js_safe_name %} = angular.module('{%= js_safe_name %}', ['MainController', 'Filters']);

{%= js_safe_name %}.config(['$routeProvider', '$locationProvider', function($routeProvider, $locationProvider) {
  $routeProvider
    .when('/', {
